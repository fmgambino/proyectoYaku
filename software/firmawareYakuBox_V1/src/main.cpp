...
#define WIFI_PIN 4    //RST GUAIFAI

const int sCap1 = 17;   // SENSOR DE NIVEL MELASA CAPACITIVO 01
const int sCap2 = 5;   // SENSOR DE HC TRIGER
const int sCap3 = 18;   // SENSOR DE HC ECHO
const int sOptico = 34; // SENSOR DE DHT
const int sTemp = 35;   // SENSOR DE PH

const int sAmp1 = 32; // Entrada 4-20 mA
const int sAmp2 = 33; // ENCODER 

// SALIDAS

#define relay1 25 
#define relay2 12
#define bomba 26 // BOMBA ANTIDERRAME / mosfet01 Actualizado
#define mosfet2 27
...
void send_to_database()
{
  ...
  else
  {
    ...
    String data = "idp=" + insert_password + "&sn=" + serial_number + "&co2=" + String(co2) + "&tempamb=" + String(tempamb) + "&hum=" + String(0) + "&ph=" + String(0) + "\r\n";
